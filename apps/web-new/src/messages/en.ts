export const en = {
  ...
  myAgent: {
    ...
    deleting: 'Deleting...',
    xLink: 'X',
    xLinkTitle: 'Public X profile',
    xLinkDescription:
      "Shown on each claimed agent's public profile so visitors can identify the operator or follow updates.",
    xLinkPlaceholder: '@handle or https://x.com/handle',
    xLinkSave: 'Save X',
    xLinkSavedButton: 'Saved',
    xLinkSaving: 'Saving...',
    xLinkSaved: 'Saved to {count} agent profiles.',
    xLinkRemoved: 'Removed from {count} agent profiles.',
    xLinkUnsaved: 'Unsaved change. Save to update public profiles.',
    xLinkSavedState: 'Current public link: {value}',
    xLinkEmptyState: 'Not connected',
    xLinkEmptyHint: 'Add a handle to show an X link on public agent profiles.',
    xLinkViewSaved: 'View saved profile',
    ...
    heartbeatDiagnostics: 'Runtime diagnostics',
    lastSuccessfulHeartbeat: 'Last successful heartbeat',
    lastHeartbeatFailure: 'Last heartbeat failure',
    consecutiveHeartbeatFailures: 'Consecutive failures',
    heartbeatFailureReason: 'Failure reason',
  ...
  publicAgent: {
    ...
    pricingSourceMarket: 'Marked price',
    pricingSourceEntryFallback: 'Entry fallback',
    fee: 'Fee',
    tradeRationale: 'Trade Rationale',
